...
func TestIntegrationCoverageBridge(t *testing.T) {
	tests := []struct {
		...
		{name: "TestCrawlRunnerContinuesAfterProcessorFailure", run: TestCrawlRunnerContinuesAfterProcessorFailure},
		{name: "TestCrawlRunnerClaimedFailureDoesNotParkUnrelatedSource", run: TestCrawlRunnerClaimedFailureDoesNotParkUnrelatedSource},
		...
		{name: "TestMultiPageCrawlerRetriesSameOriginRedirectAfterTransientFailure", run: TestMultiPageCrawlerRetriesSameOriginRedirectAfterTransientFailure},
		{name: "TestMultiPageCrawlerRejectsSameAttemptRedirectLoop", run: TestMultiPageCrawlerRejectsSameAttemptRedirectLoop},
